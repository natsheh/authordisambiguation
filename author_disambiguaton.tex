...
\title{Author Name Disambiguation using Semi-Supervised Learning and Phonetic-based Blocking Strategy}
...
solutions, and improve by proposing phonetic-based blocking strategies, thereby
increasing recall. We also publicly released the data in order to provide the basis for further research on author disambiguation.
\end{abstract}
