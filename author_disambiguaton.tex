...
The components of our method are then defined in Section~\ref{methods} and its implementation described in Section~\ref{implementation}.Experiments
...
\label{fig:rfe}
\includegraphics[width=0.4\textwidth]{fig-rfe.pdf}
\end{figure}
